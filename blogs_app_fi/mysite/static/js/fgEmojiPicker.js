...
const FgEmojiPicker = function(options) {
    ...
    this.bindEvents = () => {
        ...
        //this.lib('.emoji').on('dblclick', this.functions.removeEmojiPicker.bind(this));
    ...
    // CSS
        generateStyle() {
            document.head.insertAdjacentHTML('beforeend', `
                ...
                .fg-emoji-picker-grid > li:active{
                ...
                .fg-emoji-picker-grid > li > a:active{
                ...
                this.emojiPicker().then(emojiPicker => {
                    ...
                    if (this.variable.position) {
                        this.variable.position.forEach(elemPos => {
                            ...
                            if (elemPos === 'right') {
                                emojiPickerMain.style.left = position[elemPos]-3+'px';
                            } else if (elemPos === 'bottom') {
                                emojiPickerMain.style.top = position[elemPos]-320+'px';
                            } else {
                    ...
                    document.body.querySelector('.fg-emoji-picker').onclick =  function(e) {
                        ...
                        const el = e.target;
                        const filterLlnk = el.closest('li');
