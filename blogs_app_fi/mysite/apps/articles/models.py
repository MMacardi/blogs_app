...
class Article(models.Model):
    article_title = models.CharField('title of article', max_length = 70)
    ...
    def snippet(self):
        if len(self.article_text) >= 500: 
            return self.article_text[:500] + '...'
        else: 
...
class Comment(models.Model):
    ...
    comment_text = models.TextField('comment text', max_length = 800)
    pub_date = models.DateTimeField('date of publication', auto_now_add = True)
