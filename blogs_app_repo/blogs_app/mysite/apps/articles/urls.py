...
urlpatterns = [
    ...
    path('articles/<int:pk>/comment_delete/', MyCommentDeleteView.as_view(), name='comment_delete'),
    path('articles/<int:pk>/comment_update/', CommentUpdateView.as_view(), name='comment_update'),
